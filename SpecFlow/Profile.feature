...
Scenario: Validate if the seller can Add/Update the profile image 
	...
	When Seller Adds/Updates Profile Image
...
Scenario: Validate if the seller can Add/Update the Seller's Name
	Given Seller visits Profile page
	When Seller Adds/Updates Seller's Name
...
Scenario: Validate if the seller can Add/Update the Seller's Extra Details
	Given Seller visits Profile page
	When Seller Adds/Updates Seller's Extra Details
...
Scenario: Validate if Seller can Add Languages
	Given Seller visits Profile page
...
Scenario: Validate if Seller can Update Languages
	Given Seller has Languages in Language section
	When Seller Updates Languages
	Then verify Seller can see the updated Languages in the Language section of Profile page

Scenario: Validate if Seller Updates with same value in Languages
	Given Seller has Languages in Language section
	When Seller Updates Languages with same values in Add Language and Choose Language Level dropdown fields
	Then verify Seller can see "This Language is already added to your language list" in the Language section of Profile page

Scenario: Validate if seller Updates with MaxLength value in Language field in Languages
	Given Seller has Languages in Language section
	When Seller Updates with MaxLength value in Language field in Languages
	Then verify Seller can see the appropriate message in the Language section of Profile page


Scenario: Validate if seller Updates with Null value in Language field in Languages
	Given Seller has Languages in Language section
	When Seller Updates with Null value in Language field in Languages
	Then verify Seller can see "Please enter language and level" in the language section of Profile page  

Scenario: Validate if seller Updates with Null value in Choose Language level dropdown in Languages
	Given Seller has Languages in Language section
	When Seller Updates with Null value in Choose Language level dropdown in Languages
	Then verify Seller can see "Please enter language and level" in the language section of Profile page

Scenario: Validate if seller can Delete Languages
	Given Seller has Languages in Language section
	When Seller Deletes Languages
...
Scenario: Validate if Seller can Cancel the form while Updating a Skill
	...
	When Seller Updates Add Skill and Choose Skill Level
	And clicks Cancel button
...
Scenario: Validate if seller can Update with same value in Skills section
	Given Seller has skills in Skills section
	When Seller Updates same value in Add Skill and Choose Skill Level dropdown in Skills section
	Then verify Seller can see "This skill is already added to your skill list" in the Skills section of Profile page

Scenario: Validate if seller Updates with Null value in Add Skill field in Skills section
	Given Seller has skills in Skills section
	When Seller Updates with Null value in Add Skill field in Skills
	Then verify Seller can see "Please enter skill and experience level" in the Skills section of Profile page

Scenario: Validate if seller Updates Null value in Choose Skill Level dropdown in Skills section
	Given Seller has skills in Skills section
	When Seller Updates Null value in Choose Skill Level dropdown in Skills
	Then verify Seller can see "Please enter skill and experience level" in the Skills section of Profile page
...
Scenario: Validate if seller can Update Education
	Given Seller visits Profile page
	And Seller has Education
	When Seller Updates College/University, Country of College/University, Title, Degree, Year of Graduation
...
Scenario: Validate if seller can Update with same value in Education section
	Given Seller has Education in Education section
	When Seller Updates same value in College/University, Country of College/University, Title, Degree, Year of Graduation
	Then verify Seller can see "This information already exists" in the Education section of Profile page

Scenario: Validate if seller Updates with Null value in Education section
	Given Seller has Education in Education section
	When Seller Updates with Null value in College/University, Country of College/University, Title, Degree, Year of Graduation
	Then verify Seller can see "Please enter all the fields" in the Education section of Profile page
...
Scenario: Validate if seller can Update Certification
	...
	When Seller Updates Certificate/Award, Certified from, Year fields in Certification
...
Scenario: Validate if seller can Update with same value in Certification section
	Given Seller has Certification in Certification section
	When Seller Updates same value in Certificate/Award, Certified from, Year fields in Certification
	Then verify Seller can see "This information already exists" in the Certification section of Profile page

Scenario: Validate if seller Updates with Null value in Certificate/Award field in Certification section
	Given Seller has Certification in Certification section
	When Seller Updates with Null value in Certificate/Award field in Certification
	Then verify Seller can see "Please enter Certification Name, Certification From and Certification Year" in the Certification section of Profile page

Scenario: Validate if seller Updates with Null value in Certified from field in Certification section
	Given Seller has Certification in Certification section
	When Seller Updates with Null value in Certified from field in Certification
	Then verify Seller can see "Please enter Certification Name, Certification From and Certification Year" in the Certification section of Profile page

Scenario: Validate if seller Updates with Null value in Certification Year field in Certification section
	Given Seller has Certification in Certification section
	When Seller Updates with Null value in Certification Year field in Certification
	Then verify Seller can see "Please enter Certification Name, Certification From and Certification Year" in the Certification section of Profile page
